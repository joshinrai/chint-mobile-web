define(function (){
　　　　var gasMonthlyReportByZone = function (){
					!(function(){
							$.emptyInnerPanel() ;//清空mainbody的内容
							var chintMainInnerHtml   =  ''  ;
								  chintMainInnerHtml += '<h2>单区域逐月报表</h2>'  ;
								  ...
								  chintMainInnerHtml += 		'<thead><tr class="th-groups"><th style="width:3.15em;">日期</th><th style="width:5.15em;">当日用气量</th>' ;
