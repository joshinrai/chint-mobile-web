...
　　　　var list = function (){
					!(function(){
							...
							var chintMainInnerHtml   =  ''  ;
								  chintMainInnerHtml += '<h2>营业厅销售日报(永清)</h2>'  ;
								  chintMainInnerHtml += '<a id="filterConditionElement" href="#" data-ajax="false" style="float:right;margin-top:-3em;">过滤条件</a>' ;
								  chintMainInnerHtml += '<table id="sellDailyTable" data-role="table" data-column-btn-theme="b" data-column-popup-theme="a" data-mode="" class="table-stroke">' ;
								  ...
								  chintMainInnerHtml += '<span id="sellDailySpan" style="float:right;"></span>'  ;
