...
　　　　var list = function (){
					!(function(){
							...
							var chintMainInnerHtml   =  ''  ;
								  chintMainInnerHtml += '<h2>营业厅收费日结报表</h2>'  ;
								  chintMainInnerHtml += '<a id="filterConditionElement" href="#" data-ajax="false" style="float:right;margin-top:-3em;">过滤条件</a>' ;
								  chintMainInnerHtml += '<table id="lobbyBahrgeByDayTable" data-role="table" data-column-btn-theme="b" data-column-popup-theme="a" data-mode="" class="table-stroke">' ;
								  ...
								  chintMainInnerHtml += '<span id="lobbyBahrgeByDaySpan" style="float:right;"></span>'  ;
